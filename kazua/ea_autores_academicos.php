		...
		<?php include('header.php'); ?>
			...
			<div id="header-content-ii">
				<div id="header-extendido">
					<h1 style="text-align: left">Kazuá de Estudos Acadêmicos</h1>
					<?php include('mnu_estudos_academicos.php'); ?>					
				</div>
		...
		<div id="container">
			<div id="content">
				<div id="box-principal" style="text-align: left">
					...
					<h3 style="margin-top: 20px;">Autores Acadêmicos</h3>
					<p style="text-align: justify; margin-bottom: 20px; " >
						Todos os autores com textos aprovados pelo conselho acadêmico 
						são convidados a publicar seu livro sem qualquer ônus.
						Os autores do livro recebem 10% do valor total arrecadado com as vendas.
						Para o lançamento, e sempre que desejarem, os autores poderão adquirir 
						cópias de seus livros, com desconto variável conforme o número de cópias 
						solicitadas – mínimo de 10 cópias por pedido e desconto mínimo de 10%.
					</p>	
