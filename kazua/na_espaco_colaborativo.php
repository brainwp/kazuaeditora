...
<a href="na_espaco_colaborativo_troca_leituras.php" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:160px" class="box-botao">
	Troca de Leituras
</a>

<a href="na_espaco_colaborativo_destaque.php" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:160px" class="box-botao">
	Destaque
</a>
<a href="na_espaco_colaborativo_proponha_exercicios.php" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:160px" class="box-botao">
	Proponha seus exercícios
</a>
<a href="na_espaco_colaborativo_livro_construcao.php" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:160px" class="box-botao">
	Livro em construção
</a>
