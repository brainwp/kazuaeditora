		...
		<div id="container">
			<div id="content">
				<div id="box-principal" style="text-align: left">
					...
					<h3 style="margin-top:20px;">Processo Criativo</h3>
					<p style="text-align: justify; margin-bottom: 20px; " >
						A estrutura de uma boa história precisa ser invisível a princípio, o leitor 
						precisa mergulhar sem receio e ter o que descobrir no decorrer da leitura.<br />
						A história na mente do escritor é um marco. Escrever é um processo que começa 
						com uma ideia e depois, quando colocada no papel, ela se transforma em: um 
						tema, um enredo, uma época, um período, um cenário, personagens todos os 
						significados derivados das relações que forem estabelecidas. Sempre há um 
						ponto de partida e preciso preparar a passagem da ideia para o papel. Neste 
						sentido a Oficina Literária pode ser uma possibilidade de:
					</p>
					<p style="text-align: justify; margin-bottom: 20px; " >
						- Prestar atenção no mundo ao seu redor, com os sentidos atentos aos comportamentos 
						e reações, captando intenções, ouvindo diálogos, com olhos e ouvidos de escritor.
					</p>
					<p style="text-align: justify; margin-bottom: 20px; " >
						- Sugerir imagens com seus escritos para que a sua história alcance e 
						povoe a imaginação do leitor.
					</p>
					<p style="text-align: justify; margin-bottom: 20px; " >
						- Abuse da liberdade ao criar e convide a disciplina para lhe acompanhar na edição do material.
					</p>
					<p style="text-align: justify; margin-bottom: 20px; " >
						- Não escreva para as gavetas. Publique e mostre o seu trabalho.
					</p> 
