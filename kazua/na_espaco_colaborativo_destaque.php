		...
		<div id="container">
			<div id="content">
				<div id="box-principal" style="text-align: left">
					...
					<h3 style="margin-top:20px;">Destaque</h3>
					<p style="text-align: justify; margin-bottom: 20px; " >
						Neste espaço você pode postar textos que tiveram relevância 
						dentro das propostas das oficinas, eles podem ser próprios ou de colegas.
					</p>
					...
					<form action="post">
						...
						<div class="object">
							...
							<div class="object-control">
								<textarea name="descricao" cols="10" rows="5" ></textarea>
							</div>	
						</div>
						<div class="object">
							<div class="object-label">
								<label>texto a ser destacado:<label/>
							</div>
							<div class="object-control">
								<textarea name="texto_destacado" cols="10" rows="5" ></textarea>
							</div>	
						</div>
						<div class="object">
							<div class="object-label">
								<label>justificativa para o  destaque:<label/>
							</div>
							<div class="object-control">
								<textarea name="justificativa_destaque" cols="10" rows="5" ></textarea>
							</div>	
						</div>
						<div class="object">
							<div class="object-label">
