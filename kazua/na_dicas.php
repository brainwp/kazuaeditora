		...
		<div id="container">
			<div id="content">
				<div id="box-principal" style="text-align: left">
					...
					<a href="na_dicas_processo_criativo.php" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:215px" class="box-botao">
						Processo Criativo
					</a>
					
					<a href="na_dicas_lancamentos.php" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:215px" class="box-botao">
						Lançamento e eventos
					</a>
					<a href="na_dicas_vendas.php" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:215px" class="box-botao">
						Vendas
					</a>
					<div style="clear: both"></div>
