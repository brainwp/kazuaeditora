...
<a href="na_em_contrucao.php" style="text-align:center; margin: 2px; width:325px" class="box-botao">
	<img src="images/na-na-exercicios-dos-autores.jpg" width="325px" height="30px" />
</a>

<a href="#" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:325px" class="box-botao">
	Vagas abertas
</a>
