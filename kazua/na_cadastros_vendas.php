		...
		<div id="container">
			<div id="content">
				<div id="box-principal" style="text-align: left">
					...
					<h3 style="margin-top:20px;">Cadastros</h3>
					
					<a href="na_cadastros_lancamentos.php" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:215px" class="box-botao">
						Lançamentos e eventos
					</a>
					
					<a href="na_cadastros_vendas.php" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:215px" class="box-botao">
						Vendas
					</a>
					<a href="na_cadastros_suas_dicas.php" style="text-align:center;padding:5px 0px; margin: 2px; border: 1px solid #777; width:215px" class="box-botao">
						Deixe suas dicas
					</a>
					<div style="clear:both"></div>
					
					<h3 style="margin-top:20px;">Vendas</h3>
					<p style="text-align: justify; margin-bottom: 20px; " >
						Novos autores devem pensar que o livro requer uma trajetória após o lançamento. 
						O trabalho de divulgação de uma obra deve ser permanente: antes, durante e 
						depois de sua primeira apresentação ao público. Uma obra lançada é também um 
						produto cultural e artístico, e como tal, demanda um planejamento de mercado 
						consciente para sua venda e distribuição. Aproximar o livro do público leitor 
						interessado em sua temática é uma ação desejável, por isso, é possível pensar 
						em realizar palestras, encontros, debates ligados ao assunto tratado, bem como 
						participar de iniciativas que possam se relacionar com o que é abordado em sua publicação.
					</p>
