		...
		<div id="container">
			<div id="content">
				<div id="box-principal" style="text-align: left">
					...
					<h3 style="margin-top:20px">Dicas</h3>
										
					<h3 style="margin-top:20px;">Lançamento e eventos</h3>
					<p style="text-align: justify; margin-bottom: 20px; " >
						O lançamento de um livro possibilita ao autor ser conhecido por um público maior. 
						A Editora Kazuá efetiva, a cada nova publicação, um plano de divulgação elaborado 
						para dar visibilidade ao autor e sua obra. O planejamento prevê que sejam 
						veiculadas peças promovendo o perfil do escritor, a apresentação do livro, 
						entrevista com o autor, trechos do livro a ser lançado e informações sobre o 
						lançamento, fortalecendo a divulgação e comercialização da obra.
					</p>
					<p style="text-align: justify; margin-bottom: 20px; " >
						Para autores novos, recomendamos estabelecer parcerias com instituições, 
						tais como Casas e Centros de Cultura, para a organização do evento de lançamento. 
						Estes espaços têm em seu cerne o apoio a atividades culturais e compreendem a 
						importância do lançamento de um livro. Aliado ao lançamento é possível propor 
						eventos e vendas em locais que já atendam seu leitor potencial.
					</p>
					<p style="text-align: justify; margin-bottom: 20px; " >
						Avalie se os espaços cogitados para o lançamento não cobram algum percentual 
						sobre a arrecadação do evento e se for o caso converse com os responsáveis a 
						respeito destes valores. Fique atento aos detalhes.
					</p>
