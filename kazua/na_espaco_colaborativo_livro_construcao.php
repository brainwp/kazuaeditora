		...
		<div id="container">
			<div id="content">
				<div id="box-principal" style="text-align: left">
					...
					<h3 style="margin-top:20px;">Livro em construção</h3>
					<p style="text-align: justify; margin-bottom: 20px; " >
						A Editora Kazuá convoca autores que queiram participar de uma experiência de transmídia! 
						A proposta é acompanhar a criação de um livro na <i>web</i>, em que um autor compartilhe parte 
						de um enredo para que os usuários do portal participem de sua concepção. A intenção é, 
						além de estimular a troca de informação e conhecimento, integrar o mundo virtual ao físico, 
						já que o resultado desta experiência interativa será materializada em um livro impresso.
					</p>
					<p style="text-align: justify; margin-bottom: 20px; " >
						Entre em contato com a Editora Kazuá.
					</p>
