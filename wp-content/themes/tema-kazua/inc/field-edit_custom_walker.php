    ...
    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes); ?>">
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <p class="field-custom description description-wide">
                <label for="edit-menu-item-ajax-<?php echo $item_id; ?>">
                    <?php echo 'Ativar ajax nesse item? '; ?><br/>
                    <select class="widefat code edit-menu-item-custom" id="edit-menu-item-ajax-<?php echo $item_id; ?>"
                            value="<?php echo esc_attr($item->is_menu_ajax); ?>"
                            name="menu-item-ajax[<?php echo $item_id; ?>]">
                        <?php if ($item->is_menu_ajax == 'true'): ?>
